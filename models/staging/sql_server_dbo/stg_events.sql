...
renamed_events as (
    ...
    select
        ...
        cast(decode(product_id, null, 'Paid & Sent', '', 'Paid & Sent', product_id) as varchar(75)) as id_product,
        cast(decode(order_id, null, 'Awaiting payment', '', 'Awaiting payment', order_id) as varchar(75)) as id_order,
